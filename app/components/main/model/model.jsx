...
// Device sub-component (handles per-model loading/animation)
const Device = ({ renderer, model, modelGroup, renderFrame, index, showDelay, setLoaded, onLoad, show }) => {
