...
const { sampleSize, random, shuffle, toLower, replace, truncate } = pkg;
import dayjs from "dayjs";

// Create lodash-like object for compatibility
const _ = {
  sampleSize,
  random,
  shuffle,
...
// Use static image paths instead of globEager for SSR compatibility
const imageAssets = {};
// Generate static image asset references for profiles 1-15
for (let i = 1; i <= 15; i++) {
  imageAssets[`/src/assets/images/profile-${i}.jpg`] = { 
    default: `/images/profile-${i}.jpg` // Fallback to public images
  };
  imageAssets[`/src/assets/images/preview-${i}.jpg`] = { 
    default: `/images/preview-${i}.jpg` // Fallback to public images
  };
}
// Add other static image references
for (let i = 1; i <= 19; i++) {
  imageAssets[`/src/assets/images/food-beverage-${i}.jpg`] = { 
    default: `/images/food-beverage-${i}.jpg`
  };
}
const fakers = {
  fakeUsers() {
